...
//
//@Component
//public class ApplicationInitializationCompv1 {
//	
//	@Autowired
...
//			 paramValues.put(ParametersEnum.ENABLED, true);
//			 paramValues.put(ParametersEnum.LANGUAGE, "EN");
//			 paramMap.put("audittype", paramValues);
//			 
...
//	}
//
//	private void saveParameters(Map<String, Object> paramMap) {
//		paramMap.entrySet()
//			.forEach(entry -> {
...
//				values.entrySet()
//					.forEach(value -> {
//						parameter.setParamValues(value.getKey(), value.getValue());
//					});
//				parameter.setParamValues(entry.getKey(), entry.getKey());
