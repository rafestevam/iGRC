...
@SpringBootApplication(scanBasePackageClasses={AppMvcConfigs.class, MainController.class, Risk.class, RiskService.class, RiskRepository.class, ApplicationInitializationComp.class})
